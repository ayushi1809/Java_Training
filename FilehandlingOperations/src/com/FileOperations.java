...
public class FileOperations {
	 ...
	 do {
		 ...
		 System.out.println("======Enter the numbers given here for performing file operations======");
		 System.out.println("1: Fetch files in ascending order.");
		 System.out.println("2: For performing more operations on file ");
